...
const insertCar = (item) => __awaiter(void 0, void 0, void 0, function* () {
    const responseInsert = yield item_model_1.default.create(item);
    return responseInsert;
});
exports.insertCar = insertCar;
const getCars = () => __awaiter(void 0, void 0, void 0, function* () {
    const responseItems = yield item_model_1.default.find({});
    return responseItems;
});
exports.getCars = getCars;
const getCar = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const responseItem = yield item_model_1.default.findOne({ _id: id });
    return responseItem;
});
exports.getCar = getCar;
const updateCar = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    const responseItem = yield item_model_1.default.findOneAndUpdate({ _id: id }, data, {
...
const deleteCar = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const responseItem = yield item_model_1.default.deleteOne({ _id: id });
    return responseItem;
});
